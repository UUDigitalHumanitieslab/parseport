...
async function getRemoteUrl() {
    return new Promise((resolve, reject) => {
        exec('git config --get remote.origin.url', (error, stdout, stderr) => {
            ...
            // format is either:
            // git@github.com:UUDigitalHumanitieslab/parseport.git
            // or https://github.com/UUDigitalHumanitieslab/parseport.git
            // or https://USERNAME:SECRET@github.com/UUDigitalHumanitieslab/parseport.git/
